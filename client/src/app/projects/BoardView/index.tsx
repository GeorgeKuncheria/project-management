            ...
            <div className='mb-3 flex w-full'>
                ...
                <div className='flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary'>
                    ...
                    <div className='flex items-center gap-1'>
                        <button className='flex h-6 w-5 items-center justify-center cursor-pointer dark:text-neutral-500'>
                            <EllipsisVertical size={26}/>
                        </button>

                        <button className='flex h-6 w-6 items-center justify-center rounded cursor-pointer bg-gray-200 dark:bg-dark-tertiary dark:text-white'
        ...
        >
            ...
            <div className="p-4 md:p-6">
                <div className="flex items-start justify-between">
                    ...
                    <button className='flex h-6 w-4 flex-shrink-0 items-center justify-center dark:text-neurtal-500 cursor-pointer'>
                        <EllipsisVertical size={26}/>
                    </button>
                </div>
