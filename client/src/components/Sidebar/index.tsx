...
import { LockIcon, LucideIcon,Icon,Home, X, Briefcase, Search, Settings, User, Users, ChevronDown, ChevronUp, AlertCircle, AlertTriangle, AlertOctagon, ShieldAlert, Layers3 } from 'lucide-react';
        ...
        <div className={sidebarClassNames}>
            <div className="flex h-[100%] w-full flex-col justify-start">
                ...
                <nav className="z-10 w-full">
                    ...
                    <SidebarLink icon={User} label="Profile" href="/users" />
        ...
        return (
            <Link href={href} className="w-full">
                <div className={`relative flex cursor-pointer items-center gap-3 transition-colors 
                    hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-700 ${isActive ? "bg-gray-100 text-white dark:bg-gray-600" : ""} justify-start px-8 py-3`}>
                    {isActive && (
